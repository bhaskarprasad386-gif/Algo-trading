...
data class IntradayReplayResponse(val status: String = "", val trading_date: String = "", val symbol: String = "", val instrument_type: String = "STOCK", val contract_month: String? = null, val source_interval_minutes: Int = 1, val chart_interval_minutes: Int = 15, val count: Int = 0, val series: List<IntradayReplayPoint> = emptyList())
...
interface ApiInterface {
    ...
    @GET("/api/v1/backtesting/results/intraday-replay") suspend fun intradayReplay(@Query("trading_date") tradingDate: String, @Query("symbol") symbol: String, @Query("instrument_type") instrumentType: String = "STOCK", @Query("contract_month") contractMonth: String? = null, @Query("interval_minutes") intervalMinutes: Int = 1): IntradayReplayResponse
