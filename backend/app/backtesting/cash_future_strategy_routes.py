...
def strategy_run(request:StrategyRunRequest):
    ...
    try:
        ...
        payload["analysis"]={"final_equity":report.final_equity,"net_pnl":payload["net_profit"],"roi":payload["net_profit"]/result.initial_capital,"max_drawdown":report.max_drawdown,"max_drawdown_pct":report.max_drawdown_pct,"win_rate":report.win_rate,"profit_factor":profit_factor,"turnover":report.turnover,"wins":report.wins,"losses":report.losses,"monthly_pnl":dict(report.monthly_pnl),"yearly_pnl":dict(report.yearly_pnl)}
        return payload
