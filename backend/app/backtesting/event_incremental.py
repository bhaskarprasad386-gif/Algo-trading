    ...
    *,
    ...
    for record in events:
        ...
        if open_trade is None and action == "BUY":
            ...
            capital -= _ensure_cash_available(engine_config, capital, entry_price)
            ...
            trade = _build_trade(
                ...
                entry_event_identity=entry_identity,
                exit_event_identity=identity,
            )
            capital += _net_exit_cashflow(engine_config, entry_price, exit_price)
            trade_count += 1
    ...
    if open_trade is not None and last_price is not None:
        liquidation_pnl = _calculate_liquidation_pnl(engine_config, open_trade[1], last_price)
        final_capital = capital + liquidation_pnl
        has_open_trade = True
    else:
        liquidation_pnl = 0.0
    ...
    return BacktestResult(
        ...
        net_pnl=net_pnl,
        total_return=net_pnl / engine_config.initial_capital,
        trades=(),
        win_rate=win_rate,
        ...
        cagr=cagr,
        unrealized_pnl=liquidation_pnl,
